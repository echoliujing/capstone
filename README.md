...
The raw data is the [Reddit Comments Dataset](https://clickhouse.com/docs/en/getting-started/example-datasets/reddit-comments) from clickhouse.  Starting from this dataset, we screened the irrelevant posts to obtain iPhone-related data for this project. 
