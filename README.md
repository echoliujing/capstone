...
- Labeled data for stage 2: this folder contains the data randomly sampled for human labeling and was used for sentiment classification. It can be accessed in the folder "Labled_sentiment classification" from this Repo.    
